...
<head>
    <title> Explore | Online Grocery' </title>
</head>
...
<body   style="background-color:rgba(255, 249, 87, 0.5);">
...
?>
  ...
  ?>
                <ul class="nav navbar-nav navbar-right">
                    ...
                    <li class="active"><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span> Items
                        </a></li>
...
?>
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            ...
            <div class="item active">
                <center><img src="images/slider1.jpg" style="height:500px; width:100%;"></center>
      ...
      <div class="carousel-caption">
            ...
            <div class="item">
                <img src="images/mainimg.jpg" style="height:500px; width:100%;">
                <div class="carousel-caption">

                </div>
            </div>
            <div class="item">
                <img src="images/slide1.jpg" style="height:500px; width:100%;>
      <div class=" carousel-caption">
            </div>
        </div>
    ...
    <div class="jumbotron" style="background-color:rgba(255, 255, 25, 0.72);">
        <div class="container text-center">
            <h1 style="color:green; font-family: cursive;"> Welcome To Online Grocery </h1>
        </div>
    </div>
...
?>
        <div class="col-md-3">
            ...
            <form method="post" action="cart.php?action=add&id=<?php echo $row["F_ID"]; ?>">
                <div class="mypanel" style="height:450px;">
                    <center>
